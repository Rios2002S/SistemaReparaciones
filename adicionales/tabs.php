                        ...
                        <?php foreach ($pedidos as $pedido): ?>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <button class="btn btn-success btn-sm mb-2" onclick="imprimirPDFLib('<?= htmlspecialchars($pedido['quien_recibe']); ?>',  '<?= htmlspecialchars($pedido['claveorden']); ?>', '<?= htmlspecialchars($pedido['nombre_cliente']); ?>', '<?= htmlspecialchars($pedido['telefono_cliente']); ?>', '<?= htmlspecialchars($pedido['descripcion']); ?>', '<?= htmlspecialchars($pedido['tipo_material']); ?>', '<?= htmlspecialchars($pedido['medidas']); ?>', '<?= htmlspecialchars($pedido['sucursal_o_delivery']); ?>', '<?= htmlspecialchars($pedido['fecha_necesita']); ?>', '<?= htmlspecialchars($pedido['presupuesto_cliente']); ?>', '<?= htmlspecialchars($pedido['costo_total']); ?>', '<?= htmlspecialchars($pedido['fecha_recibe']); ?>', '<?= htmlspecialchars($trabaja); ?>')"  data-bs-toggle="tooltip" title="Comprobante"><i class="fas fa-file-pdf"></i></i></button>
                                    <!-- Botón para imprimir ticket -->
                                    <button class="btn btn-secondary btn-sm mb-2" onclick="imprimirPDFTickLib('<?= htmlspecialchars($pedido['quien_recibe']); ?>',  '<?= htmlspecialchars($pedido['claveorden']); ?>', '<?= htmlspecialchars($pedido['nombre_cliente']); ?>', '<?= htmlspecialchars($pedido['telefono_cliente']); ?>', '<?= htmlspecialchars($pedido['descripcion']); ?>', '<?= htmlspecialchars($pedido['tipo_material']); ?>', '<?= htmlspecialchars($pedido['medidas']); ?>', '<?= htmlspecialchars($pedido['sucursal_o_delivery']); ?>', '<?= htmlspecialchars($pedido['fecha_necesita']); ?>', '<?= htmlspecialchars($pedido['presupuesto_cliente']); ?>', '<?= htmlspecialchars($pedido['costo_total']); ?>', '<?= htmlspecialchars($pedido['fecha_recibe']); ?>', '<?= htmlspecialchars($trabaja); ?>')"  data-bs-toggle="tooltip" title="Ticket"><i class="fas fa-receipt"></i></button>
