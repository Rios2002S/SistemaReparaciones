...
?>
<div class="mx-5">
    <h1 class="text-center mb-4">Reportes de Reparaciones Entregadas</h1>
    <div class="mb-3 text-end">
        <button class="home-btn" onclick="window.history.back()">
            <i class="fas fa-home home-icon"></i>
        </button>
        <button id="generarPDF5" class="btn btn-danger">
...
<script>
    function imprimirPDF6(nombre_cliente, telefono_cliente, tipo_equipo, serie, problema_equipo) {
        const { jsPDF } = window.jspdf;
        const doc = new jsPDF('landscape');
