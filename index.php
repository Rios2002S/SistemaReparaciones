	...
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100">
				<form  method="POST" action="bd/verifyuser.php" class="login100-form validate-form">
					...
					<div class="wrap-input100 validate-input">
						<input class="input100" type="text" name="nombreusu" required>
					...
					<div class="wrap-input100 validate-input" data-validate="Ingrese su contraseña">
						...
						<span class="focus-input100" data-placeholder="Contraeña"></span>
					</div>
